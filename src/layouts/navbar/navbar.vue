    ...
    <nav class="navbar w-full">
      <div class="flex flex-1 md:gap-1 lg:gap-2">
        ...
        >
          ...
          >
            <span class="text-accent">C<span class="lowercase">yanery</span></span>
            <span class="text-base-content">A<span class="lowercase">dmin</span></span>
          </div>
        </RouterLink>
      </div>
      <div>
...
import LocalesChange from './locales-change.vue'
